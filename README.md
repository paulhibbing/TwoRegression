...
\#\#Overview `TwoRegression` is a package designed to simplify the use
of two-regression algorithms. The vignette (“TwoRegression”) contains
more specific information. To install the package and view the vignette,
use:
