...
read into R. You can do this with the [AGread package](https://github.com/paulhibbing/AGread),
although installation of that package might be tricky. Feel free to
[file an issue on the AGread GitHub webpage](https://github.com/paulhibbing/AGread/issues/new)
if you need extra help.

To get started, though, the TwoRegression package provides some sample data we
can use to see model application in action. If you can get your own data into a
form that mirrors the sample data, you'll be in good shape. Here's how to access
